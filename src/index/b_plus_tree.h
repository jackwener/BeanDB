//
// Created by jakevin on 2020/9/30.
//

#ifndef BEANDB_B_PLUS_TREE_H
#define BEANDB_B_PLUS_TREE_H
#include <atomic>
...
namespace DB::index {
    ...
    class BTree {
        ...
        page::parse_TableMetaPage(buffer::BufferPoolManager *buffer_pool, const char(&buffer)[page::PAGE_SIZE]);
